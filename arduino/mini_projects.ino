...
void loop() {
  ...
  switch (buttons) {
    case 1: pm_mode = 100; break;
    case 2: pm_mode = 25; break;
    case 4: pm_mode = 10; break;
  }
  switch (pm_mode) {
    case 100: pm_value = pms_data.PM_AE_UG_10_0; break;
    case 25: pm_value = pms_data.PM_AE_UG_2_5; break;
    case 10: pm_value = pms_data.PM_AE_UG_1_0; break;
  }
